...
* In order to run the Fell Finder webapp, you must first have followed the guidance on :ref:`setup_fell_loader`
...
Once startup completes, you should be able to view the app `in your browser <http://localhost:8050/>`_.