...
def test_drop_nodes_not_in_edges(test_session: SparkSession):
    """Make sure that any nodes not in a way are dropped"""
    # Arrange #################################################################
    ...
    # Act #####################################################################
    res_df = OsmLoader.drop_nodes_not_in_edges(test_nodes_df, test_edges_df)
