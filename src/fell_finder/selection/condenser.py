...
# TODO: Improve logic for setting the type of each edge, if all edges in a
#       chain have the same type, set this type for the condensed edge as well
    ...
    def _generate_hyperedge_metrics(
        ...
        for edge in edges:
            for metric in ["distance", "elevation_gain", "elevation_loss"]:
                ...
                types.add(self.graph[edge[0]][edge[1]]["type"])
        ...
        metrics["via"] = vias  # type: ignore
        metrics["type"] = type_  # type: ignore
